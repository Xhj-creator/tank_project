...
public class enemy3 : MonoBehaviour, IDamageble
{
    ...
    void Update()
    {
        ...
        else
        {
            if (timecount >= 1)
            {
                ...
                wheel.transform.rotation = Quaternion.LookRotation(Vector3.up, dir.normalized) * Quaternion.Euler(0, 0, 180);
                GameObject obj1 = Instantiate(bullet, pos0.transform.position, rotation * Quaternion.Euler(-90f, 0, 180f));
